...
export const ogImage = (text: string, options?: OgImageOptions) => {
  ...
  if (!!finalOptions.images2) {
    return `https://og-image-ismlhbb.vercel.app/ismlhbb%2F**${text}**.png?theme=${finalOptions.theme}&md=1&fontSize=${finalOptions.fontSize}&images=${finalOptions.images2}&images=${finalOptions.images2}`;
  } else {
